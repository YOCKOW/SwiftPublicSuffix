...
let package = Package(
  ...
  products: [
    ...
    .library(name: "PublicSuffixUpdaterLibrary", targets: ["PublicSuffixUpdaterLibrary"]),
    .executable(name: "PublicSuffixUpdater", targets: ["PublicSuffixUpdater"]),
  ],
  dependencies: [
    // Dependencies declare other packages that this package depends on.
    .package(url: "https://github.com/YOCKOW/SwiftStringComposition.git", from: "1.1.0"),
    .package(url: "https://github.com/YOCKOW/ySwiftCodeUpdater.git", from: "1.3.1"),
  ],
  targets: [
    // Targets are the basic building blocks of a package. A target can define a module or a test suite.
    // Targets can depend on other targets in this package, and on products in packages which this package depends on.
    .target(
      name: "PublicSuffixUpdaterLibrary",
      dependencies: [
